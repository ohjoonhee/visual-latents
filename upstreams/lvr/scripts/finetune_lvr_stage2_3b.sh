...
STAGE1_STEPS=2500
CHKPT_PATH="stage1_checkpoints/Qwen2.5-VL-3B-Instruct/Stage1_0.5TI_mseLVRLossLambda0.1-MaxVisToken5120-MinVisToken128/checkpoint-${STAGE1_STEPS}/"
...
RUN_NAME="Stage2_3B_decodingBy${DECODING_STRATEGY}_max${LVR_STEPS}lvrSteps_LR${LR}_TEMP${TEMP}_stage1Steps${STAGE1_STEPS}"
