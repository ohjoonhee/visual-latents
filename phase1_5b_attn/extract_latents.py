"""Extract Phase 1.5b latents from a trained checkpoint on the held-out
eval split, with `attention_mask_4d` injection (cross-slot isolation).

Mirrors phase1_5_attn/extract_latents.py but adds the 4D mask.
"""
